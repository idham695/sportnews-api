...
router.post("/add_berita", upload.single("gambar"), authJwt.verifyToken, berita.create);
...
router.put("/update_berita/:slug", upload.single("gambar"), authJwt.verifyToken, berita.update);
